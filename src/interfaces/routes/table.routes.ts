...
import { handleDeleteTable, handlerCreateTable, handlerGetAllTables, handleUpdateTable } from "../controllers/table.controller.js"
...
router.delete("/api/v1/tables/:id", authMiddleware, isAdmin, handleDeleteTable)
